...
export default function AdminBookSessionPage() {
	...
	const handleSelectMember = (member: Member) => {
		...
		router.push(
			`/admin/book-session/select-session?memberId=${
				member.id
		...
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Search for an active member with available sessions
					</CardDescription>
				</CardHeader>
				<CardContent>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Select a member to proceed with booking a session
					</CardDescription>
				</CardHeader>
				<CardContent>
					{loading && (
						...
						<div className="text-center py-8">
							...
							<p className="text-muted-foreground mb-2">
								{searchQuery
									...
									: "No active members with available sessions."}
							</p>
							{searchQuery && (
