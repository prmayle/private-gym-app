    ...
    (notification) =>
      (notification.subject.toLowerCase().includes(searchQuery.toLowerCase()) ||
        (notification.recipients &&
          notification.recipients.some((r) => r.name.toLowerCase().includes(searchQuery.toLowerCase())))) &&
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage all notifications sent to members</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  paginatedNotifications.map((notification) => (
                    <TableRow key={notification.id}>
                      ...
                      <TableCell className="hidden md:table-cell">
                        {notification.recipientCount || notification.recipients?.length || 0} member(s)
                      </TableCell>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="sm" asChild>
                          <Link href={`/admin/notifications/${notification.id}`}>View</Link>
                        </Button>
                      </TableCell>
                    </TableRow>
                  ))
